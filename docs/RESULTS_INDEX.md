...
| Phase 15 | S4-v3 action-conditioned predictor locked test | Data/audit complete; preliminary predictor comparison, DN-MPC not yet reopened | `PHASE15_S4_V3_LOCKED_TEST_REPORT.md`, `OFFICIAL_S4_SETUP.md` |
