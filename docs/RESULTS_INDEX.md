...
| Phase 17 | Queue-aware delayed-state rollout, uncertainty-triggered adaptive K/replanning, and reachability-normalized interception | QDR, UAKR, and RNIC adapters plus TensorBoard pilots implemented; all three are still validation-gated. QDR and RNIC show no smoke improvement claim; UAKR reduces compute but needs validation calibration. | `PHASE17_QUEUE_ADAPTIVE_REACHABILITY_TODOLIST.md`, `PHASE17_M0_QDR_SMOKE_REPORT.md`, `PHASE17_UAKR_RNIC_PILOT_REPORT.md` |
