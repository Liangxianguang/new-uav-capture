...
| Phase 17 | Queue-aware delayed-state rollout, uncertainty-triggered adaptive K/replanning, and reachability-normalized interception | QDR is No-Go on the 90-scene paired validation; UAKR gives reproducible compute savings but misses the -2 pp ID non-inferiority gate; RNIC is behavior-neutral on ID while increasing latency and still needs speed-OOD diagnostics. | `PHASE17_QUEUE_ADAPTIVE_REACHABILITY_TODOLIST.md`, `PHASE17_M0_QDR_SMOKE_REPORT.md`, `PHASE17_QDR_VALIDATION_REPORT.md`, `PHASE17_UAKR_VALIDATION_REPORT.md`, `PHASE17_RNIC_VALIDATION_REPORT.md`, `PHASE17_UAKR_RNIC_PILOT_REPORT.md`, `PHASE17_OOD_GEOMETRY_PILOT_REPORT.md` |
