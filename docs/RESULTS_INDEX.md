...
| Phase 17 | Queue-aware delayed-state rollout, uncertainty-triggered adaptive K/replanning, and reachability-normalized interception | Pre-registered; implementation and validation have not started. | `PHASE17_QUEUE_ADAPTIVE_REACHABILITY_TODOLIST.md` |
