...
| Phase 17 | Queue-aware delayed-state rollout, uncertainty-triggered adaptive K/replanning, and reachability-normalized interception | M0/QDR adapter and TensorBoard smoke path implemented; 8-episode QDR smoke is diagnostic and currently No-Go for an improvement claim. UAKR/RNIC not yet implemented. | `PHASE17_QUEUE_ADAPTIVE_REACHABILITY_TODOLIST.md`, `PHASE17_M0_QDR_SMOKE_REPORT.md` |
