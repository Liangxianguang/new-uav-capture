...
- [x] 完成 RNIC 的受限到达时间代价、central/local DN-MPC 接入、单元测试与 TensorBoard 记录；三种子 ID validation 行为与固定距离代价完全相同，但 total p95 从 135.72 ms 增至 174.19 ms，暂为 No-Go。speed-OOD 所需 RNIC 诊断字段仍未补全。详见 `docs/PHASE17_RNIC_VALIDATION_REPORT.md`。
