...
| --- | --- | --- | --- | --- | --- |
| Phase34 QDR-off historical reference | 11.03 / 22.04 / 23.80 | 12.26 / 22.51 / 25.27 | 0 / 0 / 0 | 1.16 / 2.52 / 2.85 | 27.84 / 46.53 / 51.59 |
...
相对 Phase34 QDR-off historical reference 的 total p95 `46.53 ms`，Phase40 仍增加约 `37.1%`，超过预注册的
